...
e e.size e_run: FSM_FLAGS+=-te --weak-fns-separate-file=true
e e.size e_run: CFLAGS+=-DFSM_VARIANT_E

c c.size c_run: FSM_FLAGS+=-tc --weak-fns-separate-file=true
c c.size c_run: CFLAGS+=-DFSM_VARIANT_C

s s.size s_run: FSM_FLAGS+=-ts --weak-fns-separate-file=true
s s.size s_run: CFLAGS+=-DFSM_VARIANT_S

cc cc.size cc_run: FSM_FLAGS+=-tc -c --weak-fns-separate-file=true
...
sc sc.size sc_run: FSM_FLAGS+=-ts -c --weak-fns-separate-file=true
