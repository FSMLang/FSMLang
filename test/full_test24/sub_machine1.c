...
static void * const sub_machine1_INSTANCES[top_level_numInstances];
...
TOP_LEVEL_SUB_FSM_IF top_level_sub_machine1_sub_fsm_if =
{
	...
	, .instanceArray = &sub_machine1_INSTANCES
	, .first_event = THIS(firstEvent)
	, .last_event = THIS(noEvent)
};

static SUB_MACHINE1 sub_machine1_INSTANCE0 = {
...
static void * const sub_machine1_INSTANCES[top_level_numInstances] = {
	  &sub_machine1_INSTANCE0
};

#ifndef EVENT_IS_NOT_EXCLUDED_FROM_LOG
#define EVENT_IS_NOT_EXCLUDED_FROM_LOG(e) (e == e)
#endif
static TOP_LEVEL_EVENT sub_machine1FSM(pSUB_MACHINE1 pfsm, TOP_LEVEL_EVENT event)
{
...
static TOP_LEVEL_EVENT s1_stateFn(pSUB_MACHINE1 pfsm,TOP_LEVEL_EVENT e)
{
	...
	case THIS(e1):
		...
		break;
	default:
		DBG_PRINTF("top_level_sub_machine1_noAction");
		break;
	}
...
static TOP_LEVEL_EVENT s2_stateFn(pSUB_MACHINE1 pfsm,TOP_LEVEL_EVENT e)
{
	...
	case THIS(e2):
		retVal = UFMN(a2)(pfsm);
		pfsm->state = top_level_sub_machine1_checkTransition(pfsm, e);
		break;
	default:
		DBG_PRINTF("top_level_sub_machine1_noAction");
		break;
...
char *SUB_MACHINE1_STATE_NAMES[] = {
	 "top_level_sub_machine1_s1"
	,"top_level_sub_machine1_s2"
	,"top_level_sub_machine1_s3"
};
