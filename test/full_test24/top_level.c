...
static const pTOP_LEVEL_SUB_FSM_IF top_level_sub_fsm_if_array[top_level_numSubMachines] =
{
...
static TOP_LEVEL top_level_INSTANCE0 = {
	.state = top_level_s1
	, .event = THIS(e1)
	, .statesArray = &top_level_state_fn_array
	, .subMachineArray = &top_level_sub_fsm_if_array
	, .instance = 0
	, .fsm = top_levelFSM
	};

pTOP_LEVEL ptop_level = (pTOP_LEVEL) &top_level_INSTANCE0;
