...
TRANSLATOR_RETURN_TYPE UFMN(check_configuration)(FSM_DATA_PTR pfsm_data, pCOMMUNICATOR_DATA pparent_data)
{
	DBG_PRINTF("%s", __func__);
...
ACTION_RETURN_TYPE UFMN(report_connection)(FSM_TYPE_PTR pfsm)
{
	DBG_PRINTF("%s",__func__);
	(void) pfsm;
...
void UFMN(start_scanning)(FSM_DATA_PTR pfsm_data)
{
	DBG_PRINTF("%s",__func__);
	(void) pfsm_data;
}

void UFMN(stop_scanning)(FSM_DATA_PTR pfsm_data)
{
	DBG_PRINTF("%s",__func__);
	(void) pfsm_data;
}

void UFMN(start_connection_timer)(FSM_DATA_PTR pfsm_data)
{
	DBG_PRINTF("%s",__func__);
	(void) pfsm_data;
}

void UFMN(stop_connection_timer)(FSM_DATA_PTR pfsm_data)
{
	DBG_PRINTF("%s",__func__);
	(void) pfsm_data;
}
