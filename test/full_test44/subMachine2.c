...
NEW_MACHINE_EVENT_ENUM subMachine2_sub_machine_fn(NEW_MACHINE_EVENT_ENUM e)
{
...
#endif
NEW_MACHINE_EVENT_ENUM subMachine2FSM(pSUB_MACHINE2 pfsm, NEW_MACHINE_EVENT_ENUM event)
{
/* writeOriginalSubFSM */
...
NEW_MACHINE_EVENT_ENUM __attribute__((weak)) subMachine2_aaa1(pSUB_MACHINE2 pfsm)
{
	DBG_PRINTF("weak: subMachine2_aaa1");
	return THIS(noEvent);
}

NEW_MACHINE_EVENT_ENUM __attribute__((weak)) subMachine2_aaa2(pSUB_MACHINE2 pfsm)
{
	DBG_PRINTF("weak: subMachine2_aaa2");
	return THIS(noEvent);
}

NEW_MACHINE_EVENT_ENUM __attribute__((weak)) subMachine2_noAction(pSUB_MACHINE2 pfsm)
{
