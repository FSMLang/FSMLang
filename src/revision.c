...
/*
	...
	See revision 1.43 on master.

	This revision brings the external cross reference printing feature from
	revision 1.43 to the 1.41 release.
*/
const char rev_string[] = "1.41.1-alpha";
