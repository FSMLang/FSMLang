...
typedef void (*CFSMLoopInnardsWriter)(pFSMCOutputGenerator,char*);
typedef void (*COutputFn)(pFSMCOutputGenerator);
...
struct _iterator_callback_helper_
{
	...
	pCMachineData        pcmd;       //deprecating in favor of pfsmcog;
	pFSMCOutputGenerator pfsmcog;
...
bool declare_transition_fn_ars(pLIST_ELEMENT,void*);
bool declare_transition_fn_are(pLIST_ELEMENT,void*);
bool declare_state_only_transition_functions_ars(pLIST_ELEMENT,void*);
bool declare_state_only_transition_functions_are(pLIST_ELEMENT,void*);
...
void defineSubMachineEventDataManager(pCMachineData,pMACHINE_INFO);
