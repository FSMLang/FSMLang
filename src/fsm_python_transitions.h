...
#ifndef FSM_PYTHON_TRANSITIONS_H
#define FSM_PYTHON_TRANSITIONS_H

#include "fsm_priv.h"

pFSMOutputGenerator generatePyTransitionsWriter(pFSMOutputGenerator);
